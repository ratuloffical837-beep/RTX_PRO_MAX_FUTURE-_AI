...
export default function SpotSection({ isTrial, tgUser, refreshCount, setRefreshCount }) {
  ...
  useEffect(() => {
    ...
    // Clear old signal when coin changes
    setSignal(null)
    setError(null)
  }, [selectedCoin])

  // ── Generate Signal API Call ──
    ...
    <div style={{ padding: '12px', display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      {isTrial && (
        <div style={{
          ...
          <div style={{
            fontSize: 24, fontWeight: 900, color: C.gold,
          }}>
