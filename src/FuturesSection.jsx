...
const TOP_FUTURES = [
  ...
  '1000PEPEUSDT', 'WIFUSDT', 'INJUSDT', 'SUIUSDT', 'ARBUSDT',
  'OPUSDT', 'APTUSDT', 'NEARUSDT', 'TIAUSDT', 'LTCUSDT',
]
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: `linear-gradient(90deg, ${modeColor}, ${C.pink})`,
          ...
          <div style={{
            ...
            {Math.round(progress)}% • {signalMode.toUpperCase()} Mode Analysis
          </div>
        </div>
      )}
